...
*/
// stripe api
$config['stripe_secret_key'] = 'pk_test_51P7JFTFOvjkvC5KretKTIsIFzf1Izm2it9A6ErPWs3eKbM154nBvT6GEXBJ1zVImXrr7AT1vvPJKcPL4ZDDsrXEy00yGBsJmkm';
$config['stripe_publishable_key'] = 'sk_test_51P7JFTFOvjkvC5KrDp1wOK8p71qxTAxzFB1mltzumjijnalV7Np0JIVEM5K4zp88xEEhu3kBZl1gRCX4wjJktaBz00B9mwzeX9';
$config['stripe_currency'] = 'USD';
$config['stripe_test_mode'] = true; 

// base url config
$config['base_url'] = 'https://ecommerce-m6o2.onrender.com/';
...
$config['csrf_exclude_uris'] = array(
                                ...
                                'carts/set_billing',
                                'carts/checkout',
                                'carts/change_quantity',
                                'orders/search_order',
                                'products/add_products',
                                'products/change_products',
                                'products/admin_product_search',
                                'products/admin_view',
                                'products/details/(:any)/(:any)'
                                );
